...
function LazySection({ lazyComponent: LazyComponent, minHeight = '400px', className }: LazySectionProps) {
  ...
  return (
    ...
    >
      {isVisible ? (
        <Suspense fallback={<div className={styles.skeleton} style={{ minHeight }} />}>
          <LazyComponent />
        </Suspense>
      ) : (
